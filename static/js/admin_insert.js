...
function insertstudent() {
    ...
    var url = "/admin/student/insert?student_name="+name+"&sex="+sex+"&birth_year="+birth_year+"&province="+province+"&enter_year="+enter_year+"&major_id="+major_id;
...
function insertteacher() {
    ...
    var url = "/admin/teacher/insert?teacher_name="+name+"&sex="+sex+"&birth_year="+birth_year;
    var ajaxObj = new XMLHttpRequest();
    ajaxObj.open('post', url);
    ajaxObj.send();
    ajaxObj.onreadystatechange = function () {
...
function insertcourse() {
    ...
    var url = "/admin/course/insert?course_name="+name+"&year="+year+"&semester="+semester+"&credit="+credit+"&teacher_id="+teacher_id;
    var ajaxObj = new XMLHttpRequest();
    ajaxObj.open('post', url);
    ajaxObj.send();
    ajaxObj.onreadystatechange = function () {
...
function insertmajor() {
    ...
    var url = "/admin/major/insert?major_name="+name;
    var ajaxObj = new XMLHttpRequest();
    ajaxObj.open('post', url);
    ajaxObj.send();
    ajaxObj.onreadystatechange = function () {
...
function insertmajorcourse() {
    ...
    var url = "/admin/major_course/insert?major_id="+major_id+"&course_id="+course_id;
    var ajaxObj = new XMLHttpRequest();
    ajaxObj.open('post', url);
    ajaxObj.send();
    ajaxObj.onreadystatechange = function () {
