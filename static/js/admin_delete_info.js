...
function deletestudent() {
    ...
    var url = "/admin/student/delete?student_id="+id;
    ...
    ajaxObj.onreadystatechange = function () {
        if (ajaxObj.readyState == 4 && ajaxObj.status == 200){
            ...
            alert("Delete successfully: " + obj.error);
        }
    }
}
//删除教师信息
function deleteteacher() {
    var id = document.getElementById("id").value;
    var url = "/admin/teacher/delete?teacher_id="+id;
    var ajaxObj = new XMLHttpRequest();
    ajaxObj.open('post', url);
    ajaxObj.send();
    ajaxObj.onreadystatechange = function () {
...
function deletecourse() {
    var id = document.getElementById("id").value;
    var url = "/admin/course/delete?course_id="+id;
    var ajaxObj = new XMLHttpRequest();
    ajaxObj.open('post', url);
    ajaxObj.send();
    ajaxObj.onreadystatechange = function () {
...
function deletemajor() {
    var id = document.getElementById("id").value;
    var url = "/admin/major/delete?major_id="+id;
    var ajaxObj = new XMLHttpRequest();
    ajaxObj.open('post', url);
    ajaxObj.send();
    ajaxObj.onreadystatechange = function () {
...
function deletemajorcourse() {
    ...
    var url = "/admin/major_course/delete?major_id="+major_id+"&course_id="+course_id;
    var ajaxObj = new XMLHttpRequest();
    ajaxObj.open('post', url);
    ajaxObj.send();
    ajaxObj.onreadystatechange = function () {
