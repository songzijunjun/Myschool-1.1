...
function modifystudent() {
    ...
    var url = "/admin/student/update?student_id="+id+"&student_name="+name+"&sex="+sex+"&birth_year="+birth_year+"&province="+province+"&enter_year="+enter_year+"&major_id="+major_id;
...
function modifyteacher() {
    ...
    var url = "/admin/teacher/update?teacher_id="+id+"&teacher_name="+name+"&sex="+sex+"&birth_year="+birth_year;
    var ajaxObj = new XMLHttpRequest();
    ajaxObj.open('post', url);
    ajaxObj.send();
    ajaxObj.onreadystatechange = function () {
...
function modifycourse() {
    ...
    var url = "/admin/course/update?course_id="+id+"&course_name="+name+"&year="+year+"&semester="+semester+"&teacher_id="+teacher_id+"&credit="+credit;
    var ajaxObj = new XMLHttpRequest();
    ajaxObj.open('post', url);
    ajaxObj.send();
    ajaxObj.onreadystatechange = function () {
...
function modifymajor() {
    ...
    var url = "/admin/major/update?major_id="+id+"&major_name="+name;
    var ajaxObj = new XMLHttpRequest();
    ajaxObj.open('post', url);
    ajaxObj.send();
    ajaxObj.onreadystatechange = function () {
